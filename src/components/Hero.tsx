      ...
      <div className="absolute inset-0 z-0 select-none bg-neutral-950">
        ...
        {!videoHasError && (
          <video
            ...
            className={`absolute inset-0 w-full h-full object-cover object-center scale-[1.08] transition-all duration-1000 pointer-events-none ${videoLoaded ? "opacity-90" : "opacity-0"
              }`}
          >
