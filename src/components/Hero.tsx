  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 select-none bg-neutral-950">
        {/* Placeholder image from the first frame of car-video1.mp4, fading in when loaded */}
        <img
          src="/car-video1-placeholder.jpg"
          alt="Premium Car Wash Background Placeholder"
          onLoad={() => setPosterLoaded(true)}
          className={`absolute inset-0 w-full h-full object-cover object-center scale-[1.08] transition-opacity duration-1000 pointer-events-none ${
